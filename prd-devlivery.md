...
- `POST /api/public/scan` *(Endpoint Publik)*
...
- `GET /api/public/collab/:share_token` *(Endpoint Publik)*
  - **Response**: `{ "campaign_id": "...", "type": "email_editor", "template_data": { ... } }`
- `PUT /api/public/collab/:share_token` *(Endpoint Publik)*
